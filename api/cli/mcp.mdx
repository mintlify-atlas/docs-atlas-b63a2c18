...
sidebarTitle: "mcp"
description: "Reference for all headroom mcp subcommands: install, serve, uninstall, and status — plus the MCP server tool spec for headroom_compress, headroom_retrieve, and headroom_stats."
---
