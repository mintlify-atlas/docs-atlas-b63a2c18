---
title: "headroom CLI Utility Commands Reference"
sidebarTitle: "Utilities"
description: "Reference for headroom doctor, perf, savings, output-savings, dashboard, update, init, copilot-auth, and capture CLI commands."
---
...
`headroom dashboard` opens a live savings dashboard in your terminal. The proxy must be running.
