---
title: "headroom wrap — One-Command AI Agent Integration"
sidebarTitle: "wrap"
description: "Full reference for headroom wrap and unwrap: supported tools, flags, Claude options, Copilot subscription mode, and the HEADROOM_CONTEXT_TOOL env var."
---
...
<ParamField query="--provider-type" type="auto | anthropic | openai" default="auto">
  Copilot BYOK provider mode. `auto` selects `anthropic` for the default backend and `openai` for translated backends.
</ParamField>

<ParamField query="--wire-api" type="completions | responses">
