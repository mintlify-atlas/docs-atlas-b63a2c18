---
title: "Headroom: Context Compression for LLM Agents"
sidebarTitle: "Introduction"
description: "Headroom is a local-first context compression layer that cuts LLM token usage by 60–95% across tool outputs, logs, RAG chunks, files, and conversation history."
---
