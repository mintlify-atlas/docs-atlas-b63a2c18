---
title: "How Headroom Compresses Your Agent's Context Window"
sidebarTitle: "Compression"
description: "A deep dive into Headroom's content-aware compression pipeline: auto-detection, SmartCrusher, CodeAwareCompressor, Kompress-v2-base, and per-type savings."
---
...
<Note>
  Code compression via `CodeAwareCompressor` is opt-in and disabled by default.
